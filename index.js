...
const sessdata = config.SESSION_ID.split("𝐒𝐄𝐍𝐔-𝐌𝐃=")[1];
...
console.log("Connecting Senu Md bot 🧬...");
...
conn.ev.on("connection.update", async (update) => {
  ...
  if (connection === "close") {
    ...
    const plugins = [
      {
        'url': "githubusercontent link එක දාපිය",
          'id': "File එකේ නම දාපන"
        }, {
          'url': "githubusercontent link එක දාපිය",
          'id': "File එකේ නම දාපන"
...
console.log("Successful join our support 🧑‍💻");
    console.log("Senu Md Bot connected to WhatsApp ✅");

let up = `* *Connecting 𝐒𝐄𝐍𝐔-𝐌𝐃 Multidevice Whatsapp Bot ...💾*
