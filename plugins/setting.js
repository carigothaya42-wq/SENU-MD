...
🔢 𝐑ᴇᴘʟʏ 𝐁ᴇʟᴏᴡ 𝐓ʜɪꜱ 𝐍ᴜᴍʙᴇʀ 𝐂ʜᴀɴɢᴇ 𝐓ᴏ 𝐒ᴇɴᴜ -- 𝐌ᴅ 𝐁ᴏᴛ 𝐂ʜᴀɴɢᴇ 𝐒ᴇᴛᴛɪɴɢ.....❍

> 𝐏ᴏᴡᴇʀᴅ 𝐁ʏ 𝐒ᴇɴᴜ_𝐌ᴅ......👁️❗`;

        const vv = await conn.sendMessage(from, { image: { url: "https://i.ibb.co/bjPrbF84/3174.jpg"}, caption: desc }, { quoted: mek });
