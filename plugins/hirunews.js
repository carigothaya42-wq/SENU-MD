...
cmd({
    ...
    desc: "Fetch the latest news from the SENU API in Hiru API.",
    use: "",
    filename: __filename,
},
    async (conn, mek, m, {
...
//Dont Change This API Key
            ...
            let newsInfo = "𝐒𝐄𝐍𝐔-𝐌𝐃 𝐇𝐢𝐫𝐮 𝐍𝐞𝐰𝐬 𝐔𝐩𝐝𝐚𝐭𝐞 📰\n\n";
            newsInfo += `✨ *ᴛɪᴛʟᴇ*: ${title}\n\n`;
            newsInfo += `📑 *ᴅᴇꜱᴄʀɪᴘᴛɪᴏɴ*:\n${text}\n\n`;
            newsInfo += `⛓️‍💥 *ᴜʀʟ*: www.hirunews.lk\n\n`;
            newsInfo += `> *𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐒𝐄𝐍𝐔_𝐌𝐃 💛*\n\n`;
