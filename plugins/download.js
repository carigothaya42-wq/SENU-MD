...
cmd({
    ...
    try {
        ...
        let captionMessage = `🎵 *𝐒𝐄𝐍𝐔 𝐓𝐈𝐊𝐓𝐎𝐊 𝐃𝐋!*\n\n`;
        captionMessage += `📌 *ᴄᴀᴘᴛɪᴏɴ:* ${videoData.caption_vid || "No caption"}\n`;
        captionMessage += `👀 *ᴠɪᴇᴡꜱ:* ${videoStats.views}\n`;
        captionMessage += `❤️ *ʟɪᴋᴇꜱ:* ${videoStats.likes}\n`;
        captionMessage += `💬 *ᴄᴏᴍᴍᴇɴᴛꜱ:* ${videoStats.comments}\n`;
        captionMessage += `🔁 *ꜱʜᴀʀᴇꜱ:* ${videoStats.shares}\n`;
        captionMessage += `👤 *ᴀᴜᴛʜᴏʀ:* ${author.nickname} (@${author.username})\n`;
        captionMessage += `\n🔹 *ʀᴇᴘʟʏ ᴡɪᴛʜ:* \n 1️⃣ for *ᴠɪᴅᴇᴏ* 📽️ \n 2️⃣ for *ᴀᴜᴅɪᴏ* 🎵`;
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐒𝐄𝐍𝐔 𝐌𝐅 𝐃𝐋* 〕━━━⊷\n`
      + `┃▸ *ꜰɪʟᴇ ɴᴀᴍᴇ:* ${file_name}\n`
      + `┃▸ *ꜰɪʟᴇ ᴛʏᴘᴇ:* ${mime_type}\n`
      + `╰━━━⪼\n\n`
      + `📥 *ᴅᴏᴡɴʟᴏᴀᴅɪɴɢ ʏᴏᴜʀ ꜰɪʟᴇ...*`;
...
cmd({
  ...
  try {
    ...
    const caption = `╭━━━〔 *𝐒𝐄𝐍𝐔-𝐌𝐃 𝐀𝐏𝐊 𝐃𝐋* 〕━━━┈⊷
┃ 📦 *ɴᴀᴍᴇ:* ${app.name}
┃ 🏋 *ꜱɪᴢᴇ:* ${appSize} MB
┃ 📦 *ᴘᴀᴄᴋᴀɢᴇ:* ${app.package}
┃ 📅 *ᴜᴘᴅᴀᴛᴇ ᴏɴ:* ${app.updated}
...
cmd({
  ...
  try {
    ...
    await conn.sendMessage(from, {
      ...
      caption: `📥 *ᴅᴏᴡɴʟᴏᴀᴅᴇᴅ ɪɴ ${videoData.quality} Qᴜᴀʟɪᴛy*\n\n> 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘 𝐒𝐄𝐍𝐔_𝐌𝐃 💛`
    }, { quoted: m });
